    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.level')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cls', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='school.class')),
        ...
        migrations.AddField(
            model_name='student',
            name='subject_terms',
            field=models.ManyToManyField(to='school.terms', verbose_name='name'),
        ),
        migrations.AddField(
            model_name='student',
            name='user',
        ...
        migrations.AddField(
            model_name='class',
            name='instructor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='school.staff'),
        ),
        migrations.AddField(
            model_name='class',
            name='level',
