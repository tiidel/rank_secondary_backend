# Generated by Django 4.2.4 on 2024-04-13 16:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_seq', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='First sequence grade')),
                ('second_seq', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Second sequence grade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade_list', models.ManyToManyField(related_name='student_grades', to='school.studentsubjects', verbose_name='Student Subject Grades')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.student')),
