# Generated by Django 4.2.4 on 2024-04-29 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_id', models.CharField(blank=True, max_length=100, null=True)),
                ('is_complete', models.BooleanField(default=False)),
                ('expected_ammount', models.IntegerField(verbose_name='The amount student is expected to pay for the class')),
                ('payed_ammount', models.IntegerField(default=0, verbose_name='Money student has actually paid for the school year')),
                ('registration_status', models.CharField(choices=[('none', 'None'), ('first', 'First'), ('second', 'Second'), ('complete', 'Complete')], max_length=50, verbose_name='fee installment. partial or complete')),
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('payments', models.ManyToManyField(null=True, related_name='registrationPayment', to='school.payment')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.student')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.program')),
            ],
            options={
